package com.aks.android_ui_library.tokens
...
object AppTypography {
    ...
    val Typography.display: TextStyle
        @Composable @ReadOnlyComposable get() = displayLarge

    val Typography.headline: TextStyle
        @Composable @ReadOnlyComposable get() = headlineSmall

    val Typography.title: TextStyle
        @Composable @ReadOnlyComposable get() = titleMedium

    val Typography.body: TextStyle
        @Composable @ReadOnlyComposable get() = bodyMedium

    val Typography.label: TextStyle
        @Composable @ReadOnlyComposable get() = labelMedium

    val Typography.caption: TextStyle
        @Composable @ReadOnlyComposable get() = labelSmall
}
